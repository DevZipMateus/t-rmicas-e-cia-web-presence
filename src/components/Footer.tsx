        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-lg font-bold">TÉRMICAS E CIA</span>
            </div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a
                  ...
                  className="flex items-center gap-2 text-background/80 hover:text-primary transition-colors text-sm break-all"
                >
                  <Mail size={16} />
